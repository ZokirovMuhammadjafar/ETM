...
public class Application {
    ...
    private static void run() {
        ...
        else if ("CRETE COMMENT".equals(choice) && SecurityHolder.hasPermission("CRETE_TASK")) taskUI.create();

        else if ("CRETE LABEL".equals(choice) && SecurityHolder.hasPermission("CRETE_LABEL")) taskUI.create();
